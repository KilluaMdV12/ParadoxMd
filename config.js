...
const config = {
    ...
    //  APIkey
    APIkey: {
        lolhuman: 'b3942e7a1c988827cc70aa32',
        neoxr: 'aMivcR',
        google: 'AIzaSyArMFXkBjaMuYduDUX6NT79cnqELSmNo-k',
        groq: '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' // API Key Groq untuk fitur transkrip (gratis di console.groq.com)
    }
};
