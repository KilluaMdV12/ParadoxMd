...
function getGiveawayImage() {
    ...
    const defaultPath = path.join(process.cwd(), 'assets', 'images', 'zenos.jpg')
    ...
    if (action === 'start' || action === 'create' || action === 'new') {
        ...
        try {
            ...
            try {
                ...
                try {
                    thumbnail = fs.readFileSync('./assets/images/zenos.jpg')
                } catch (e2) {}
            }
            ...
            await sock.sendMessage(m.chat, {
                ...
                contextInfo: {
                    ...
                    externalAdReply: thumbnail ? {
                        title: botConfig.bot?.name || 'Zenos MD',
                ...
                footer: botConfig.bot?.name || 'ZENOS MD',
                interactiveButtons: [
                    {
                        name: 'single_select',
