...
try {
    ...
    if (fs.existsSync(path.join(assetsPath, 'zenos-games.jpg'))) {
        thumbWW = fs.readFileSync(path.join(assetsPath, 'zenos-games.jpg'))
    }
    if (fs.existsSync(path.join(assetsPath, 'zenos.jpg'))) {
        thumbNight = fs.readFileSync(path.join(assetsPath, 'zenos.jpg'))
        thumbDay = fs.readFileSync(path.join(assetsPath, 'zenos.jpg'))
    }
    if (fs.existsSync(path.join(assetsPath, 'zenos-winner.jpg'))) {
        thumbWin = fs.readFileSync(path.join(assetsPath, 'zenos-winner.jpg'))
    }
} catch (e) {
