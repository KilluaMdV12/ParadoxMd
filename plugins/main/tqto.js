...
async function handler(m, { sock }) {
    ...
    const developer = config.bot?.developer || 'Laww'
    
    const credits = [
        { name: 'Laww', role: 'Staff', icon: '👨‍💻' },
        { name: 'Laww', role: 'Developer', icon: '👨‍💻' },
    ...
    let thumbPath = path.join(process.cwd(), 'assets', 'images', 'zenos.jpg')
