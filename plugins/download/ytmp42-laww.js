...
const pluginConfig = {
    name: 'ytmp42-laww',
    alias: ['youtubemp42-laww', 'ytaudio2-laww'],
    category: 'download',
    description: 'Download video YouTube (quality selected)',
    usage: '.ytmp42-laww <url> <quality>',
    example: '.ytmp42-laww https://youtube.com/watch?v=xxx 720p',
    cooldown: 20,
    energi: 2,
    isEnabled: true
}
...
async function handler(m, { sock }) {
    ...
    if (!url) {
        return m.reply(`Contoh: ${m.prefix}ytmp42-laww https://youtube.com/watch?v=xxx 720p`)
    }
