...
const pluginConfig = {
    ...
    example: '.xprofile Laww|Laww Official|Developer|9400|120|January 1, 2000|January 2025|true',
    isOwner: false,
    isPremium: false,
    isGroup: false,
    isPrivate: false,
...
async function handler(m, { sock }) {
    ...
    if (!text || !text.includes('|')) {
        return m.reply(
            ...
            `*Contoh:*\n` +
            `> \`${m.prefix}xprofile Laww|Laww|Dev|9400|120|January 1, 2000|January 2025|true\`\n\n` +
