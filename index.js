...
console.log = (...args) => {
  const msg = args
    .map((a) => {
      if (typeof a === "object") {
        try {
          // Limit stringify to small objects or provide a placeholder for large ones
          const str = JSON.stringify(a);
          return str.length > 500 ? "[Large Object]" : str;
        } catch { return "[Circular/Complex Object]"; }
      }
      return String(a);
    })
    .join(" ");
