...
function printBanner(mini = false) {
  console.clear();
  if (mini) {
    console.log(bannerGradient("  ZENOS-AI • WhatsApp Bot Engine"));
    console.log("");
    return;
  }
  console.log("");
  const ascii = figlet.textSync("ZENOS AI", { font: "ANSI Shadow", horizontalLayout: "fitted" });
  console.log(bannerGradient(ascii));
  console.log(bannerGradient("  ══════════════════════════════════════"));
  console.log(`  ${chalk.hex("#6B7280")("WhatsApp Bot Engine")} ${chalk.hex("#374151")("│")} ${chalk.hex("#00FF88")("Powered by Zenos")}`);
  console.log(bannerGradient("  ══════════════════════════════════════"));
  console.log("");
}
