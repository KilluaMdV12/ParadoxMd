...
const { handleCommand: handleCaseCommand } = require("../case/zenos");
const fs = require("fs");
...
function getSmartTriggerThumb() {
  ...
  try {
    const p = './assets/images/zenos2.jpg';
...
async function handleSmartTriggers(m, sock, db) {
  ...
  try {
    ...
    if (
      ...
      text?.toLowerCase().includes("zenos")
    ) {
      await sock.sendMessage(
        m.chat,
        {
          ...
          await sock.sendMessage(
            m.chat,
            {
              interactiveMessage: {
                ...
                document: fs.readFileSync('./assets/images/zenos.jpg'),
                ...
                externalAdReply: {
                  title: "Command " + m.command ? m.command + " Tidak Ditemukan" : "Tidak Ditemukan",
    ...
    for (let participant of participants) {
      ...
      if (action === "promote" && groupData.notifPromote === true) {
        ...
        await sock.sendMessage(groupJid, {
          image: fs.readFileSync('./assets/images/zenos-promote.jpg'),
          caption:
            `╭━━━━━━━━━━━━━━━━━╮\n` +
            `┃  👑 *ᴘʀᴏᴍᴏᴛᴇ*\n` +
            `╰━━━━━━━━━━━━━━━━━╯\n\n` +
      ...
      if (action === "demote" && groupData.notifDemote === true) {
        ...
        await sock.sendMessage(groupJid, {
          image: fs.readFileSync('./assets/images/zenos-demote.jpg'),
          caption:
            `╭━━━━━━━━━━━━━━━━━╮\n` +
            `┃  📉 *ᴅᴇᴍᴏᴛᴇ*\n` +
            `╰━━━━━━━━━━━━━━━━━╯\n\n` +
